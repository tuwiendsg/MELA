package at.ac.tuwien.dsg.mela.healthanalysis.cxf;
...
@Provider
@Component
public class MelaHealthAnalysisServiceExceptionMapper implements ExceptionMapper<Exception> {

    static final Logger log = LoggerFactory.getLogger(MelaHealthAnalysisServiceExceptionMapper.class);
