 ...
 * collected monitoring information for a MonitoredElement
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "MonitoredElementMonitoringSnapshot")
public class MonitoredElementMonitoringSnapshot {
    ...
    @XmlElement(name = "MonitoredData")
    private Map<Metric, List<MetricValue>> monitoredData;
    ...
    public Map<Metric, List<MetricValue>> getMonitoredData() {
        return monitoredData;
    }

    public void setMonitoredData(Map<Metric, List<MetricValue>> monitoredData) {
