...
public class ElasticityDependencyElement implements Serializable {
    ...
    public static final String ESTIMATION_ERROR_MIN = "minError";
    public static final String ESTIMATION_ERROR_MAX = "maxError";
    public static final String ESTIMATION_ERROR_AVERAGE = "avgError";
    public static final String ESTIMATION_ERROR_STD_DEVIATION = "stdDev";
