 ...
 * the License.
 */
package at.ac.tuwien.dsg.mela.common.utils.outputConverters;
...
public class JsonConverter {
    ...
    public String convertElasticityPathway(List<Metric> metrics, List<Neuron> elPathwayGroups) {
    ...
    public String convertElasticitySpace(ElasticitySpace space, MonitoredElement MonitoredElement) {

        if (space == null || MonitoredElement == null) {
            Logger.getLogger(JsonConverter.class).log(Level.WARN, "Elasticity Space or supplied Service Element are null");
            JSONObject elSpaceJSON = new JSONObject();
...
//    }
    ...
    public static String convertMonitoringSnapshot(ServiceMonitoringSnapshot serviceMonitoringSnapshot) {
