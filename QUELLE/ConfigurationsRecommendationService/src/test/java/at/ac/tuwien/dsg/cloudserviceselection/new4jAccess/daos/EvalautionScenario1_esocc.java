 ...
 */
public class EvalautionScenario1_esocc extends TestCase {
...
////
        Writer writer = new FileWriter("./experiments/scenario1_esocc.csv");
    ...
    public void addRequirements(List<Strategy> strategies, List<MultiLevelRequirements> requirementsIteration) {
        {
            try {
                ...
                Logger.getLogger(EvalautionScenario1_esocc.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
