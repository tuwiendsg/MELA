...
//
                ...
                for (ElasticityDependencyCoefficient coefficient : dependencyElement.getCoefficients()) {
                    ...
                    childJSON.put("confidence", dependencyElement.getAdjustedR());
                    childJSON.put("stdError", coefficient.getStdError());
                    childJSON.put("coefficient", coefficient.getCoefficient());
                    childJSON.put("lag", coefficient.getLag());
    ...
    public ServiceElasticityDependencies analyzeElasticityDependencies(MonitoredElement monitoredElement) {
        ...
        if (determinedDependencies != null && elasticitySpace.getTimestampID() == determinedDependencies.getTimestampID()) {
