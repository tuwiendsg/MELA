/**
 * Retired class. There should be no need in doing an ssh and then telnet. MELA should be deployed from a location where it can execute telnet.
 */
...
// * 
// */
//public class RemoteGangliaLiveDataSource implements IDataSource {
//
...
//
//	public RemoteGangliaLiveDataSource(String monSeqID) {
//		super();
...
//														// MyUserInfo
//
//			jSch.addIdentity(Configuration.getAccessUserName(), // String
//																// userName
...
//			session.setConfig("StrictHostKeyChecking", "no"); // Session session
//																// =
...
//	// String content= "";
//	// try {
//	// content = execute(rootIPAddress, securityCertificatePath, gangliaPort,
//	// command);
...
//		String content = "";
//		try {
//			content = executeSSH(Configuration.getAccessUserName(), Configuration.getAccessMachineIP(), Configuration.getSecurityCertificatePath(), Configuration.getGangliaPort(),
//					cmd);
//		} catch (JSchException e1) {
//			// TODO Auto-generated catch block
//			e1.printStackTrace();
