...
public class MELADataService {
    ...
    public void createInitialStructure() {
        ...
        try {
            ...
            connection.createStatement().execute("create CACHED table MonitoringSeq (ID VARCHAR(200) PRIMARY KEY);");
            connection
                    .createStatement()
                    .execute(
            ...
            connection.createStatement().execute("create CACHED table Configuration (ID int IDENTITY, configuration LONGVARCHAR);");
            connection
                    .createStatement()
                    .execute(
    ...
    public void createInitialStructureIfItDoesNotExist() {
        ...
        try {
            ...
            connection.createStatement().execute("create CACHED table IF NOT EXISTS MonitoringSeq (ID VARCHAR(200) PRIMARY KEY);");
            connection
                    .createStatement()
                    .execute(
            ...
            // ServiceStructure,
            // CompositionRules, and Requirements
            connection.createStatement().execute("create CACHED table IF NOT EXISTS Configuration (ID int IDENTITY, configuration LONGVARCHAR);");
            connection
                    .createStatement()
                    .execute(
