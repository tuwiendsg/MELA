...
public class MELADataService {
    ...
    public void createInitialStructure() {
        ...
        try {
            ...
            connection.createStatement().execute(
                    "create table ElasticitySpace (ID int IDENTITY, monSeqID VARCHAR(200), timestampID int, elasticitySpace OTHER, FOREIGN KEY (monSeqID) REFERENCES MonitoringSeq(ID), FOREIGN KEY (timestampID) REFERENCES Timestamp(ID) );");
            connection.createStatement().execute(
                    "create table ElasticityPathway (ID int IDENTITY, monSeqID VARCHAR(200), timestampID int, elasticitySpaceID int, elasticityPathway OTHER, FOREIGN KEY (monSeqID) REFERENCES MonitoringSeq(ID), FOREIGN KEY (timestampID) REFERENCES Timestamp(ID) , FOREIGN KEY (elasticitySpaceID) REFERENCES ElasticitySpace(ID) );");
    ...
    public void createInitialStructureIfItDoesNotExist() {
        ...
        try {
            ...
            connection.createStatement().execute(
                    "create table IF NOT EXISTS ElasticitySpace (ID int IDENTITY, monSeqID VARCHAR(200), timestampID int, elasticitySpace OTHER, FOREIGN KEY (monSeqID) REFERENCES MonitoringSeq(ID), FOREIGN KEY (timestampID) REFERENCES Timestamp(ID) );");
            connection.createStatement().execute(
                    "create table IF NOT EXISTS ElasticityPathway (ID int IDENTITY, monSeqID VARCHAR(200), timestampID int, elasticitySpaceID int, elasticityPathway OTHER, FOREIGN KEY (monSeqID) REFERENCES MonitoringSeq(ID), FOREIGN KEY (timestampID) REFERENCES Timestamp(ID) , FOREIGN KEY (elasticitySpaceID) REFERENCES ElasticitySpace(ID) );");
